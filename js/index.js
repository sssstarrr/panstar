...
function(e, t, n) {
    ...
    t.disableWebgl = !!window.ANZHIYU_DISABLE_WEBGL,
    t.typekitId = "AnZhiYu",
    t.assetPath = i ? "./assets/": "/assets/",
    t.cdnPath = i ? "./assets/": "/assets/",
    t.videoCdnPath = "https://d8d3yaw9yoj7k.cloudfront.net/",
...
function(e, t, n) {
    ...
    t.preload = function(e) {
        if (!d || !m) return;
        if (i.isLocal && e && !e.startsWith("https://") && !e.startsWith("http://") && "default" !== e) return;
...
function(e, t, n) {
    ...
    P = !1;
    function R() {
        a.isSupportWebGL && document.documentElement.classList.add("use-webgl"),
    ...
    i = window,
    a.isSupportWebGL = !o.disableWebgl && _.checkIsSupported(a.canvas = document.getElementById("canvas")),
...
function(e, t, n) {
    ...
    t.add = function(e) {
        if (window.atob) {
            ...
            t && (i.isFirefox || i.isChrome ? t.log.apply(t, ["\n" + (e ? atob("JWMgQ3JlYXRlZCBieSBBblpoaVl1ICVjIGh0dHBzOi8vZ2l0aHViLmNvbS9hbnpoaXl1LWM=") : atob("JWMgRGV2ZWxvcGVkIGJ5IEphY2tjaGVuMDA3ICVjIGh0dHBzOi8vZ2l0aHViLmNvbS9qYWNrY2hlbjAxMjA=")) + "\n", atob("Y29sb3I6ICNmZmY7IGJhY2tncm91bmQ6ICMyMjI7IHBhZGRpbmc6NXB4IDVweDs="), atob("Y29sb3I6ICM5OTk7IGJhY2tncm91bmQ6ICNGQ0ZDRkM7IHBhZGRpbmc6NXB4IDA7")]) : t.log(atob(e ? "JWMgQ3JlYXRlZCBieSBBblpoaVl1ICVjIGh0dHBzOi8vZ2l0aHViLmNvbS9hbnpoaXl1LWM=": "JWMgRGV2ZWxvcGVkIGJ5IEphY2tjaGVuMDA3ICVjIGh0dHBzOi8vZ2l0aHViLmNvbS9qYWNrY2hlbjAxMjA=")))
        }
    }
},
function(e, t, n) {
...
function(e, t, n) {
    ...
    v.loadImage = function() {
        if (!this.startedLoading) {
            ...
            var e = this,
            t = this.thumb,
            n = this.imageContainer.style.backgroundImage,
            a = n && n.match(/url\(["']?(.*?)["']?\)/),
            s = a ? a[1] : r.cdnPath + "images/" + this.id + "/" + (r.isLocal ? "desktop_home_thumb.png": "desktop_home.png");
            o.loader.load(s, {
                onLoad: function(n) {
                    e.image = n,
                    e.imageContainer.style.backgroundImage = "none",
                    ...
                    1e3)) : (n.style.opacity = i.isMobile ? 0.5 : 1, t && t.parentNode && t.parentNode.removeChild(t), e.thumb = null)
                }
            })
        }
    },
...
function(e, t, n) {
    ...
    h.constructor = d,
    h.preInit = function() {
        allowHomeWebgl = u.isSupportWebGL && !localConfig.isLocal,
        allowHomeWebgl && (i.preInit(), r.preInit(), o.preInit())
    },
    h.init = function() {
        allowHomeWebgl && (i.init(), r.init(), o.init());
    ...
    h.update = function(e, t) {
        if (this.hasInitialized) {
            ...
            allowHomeWebgl && (i.update(e), o.update(e), b.testViewport(), r.update(e, b, n, a, y.lastLineRatio))
        }
...
function(e, t, n) {
    ...
    function d() {
        ...
        f.constructor.call(this, {
            ...
            domRect: null,
            aliases: ["about"],
            audioId: o.isLocal ? "local-disabled": randomAudioLink
        })
    }
    var f = n(18).prototype,
    h = d.prototype = Object.create(f);
